...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): any => { // need to fix any
    if (filter === 'low') return affairs.filter(affairFilter => affairFilter.priority === 'low')
    if (filter === 'middle') return affairs.filter(affairFilter => affairFilter.priority === 'middle')
    if (filter === 'high') return affairs.filter(affairFilter => affairFilter.priority === 'high')
    return affairs // need to fix
}
export const deleteAffair = (affairs: AffairType[], _id: number): any => { // need to fix any
    return affairs.filter(del => del._id !== _id) // need to fix
}
